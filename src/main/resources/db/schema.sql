...
CREATE TABLE `tb_blog`  (
  ...
  `liked` int(8) UNSIGNED NULL DEFAULT 0 COMMENT '鐐硅禐鏁伴噺',
...
CREATE TABLE `tb_sign`  (
  ...
  `month` tinyint(2) NOT NULL COMMENT '绛惧埌鐨勬湀',
  `date` date NOT NULL COMMENT '绛惧埌鐨勬棩鏈?,
  `is_backup` tinyint(1) UNSIGNED NULL DEFAULT NULL COMMENT '鏄惁琛ョ',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
INSERT INTO `tb_user` VALUES (5, '13456789001', '', '鍙埍澶?, '/imgs/icons/user5-icon.png', '2022-01-07 16:11:33', '2022-03-11 09:09:20');
...
CREATE TABLE `tb_voucher_order`  (
  ...
  `user_id` bigint(20) UNSIGNED NOT NULL COMMENT '涓嬪崟鐨勭敤鎴穒d',
